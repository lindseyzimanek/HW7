...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server"> NFL Teams - View All Teams
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" Width="478px">
        <Columns>
